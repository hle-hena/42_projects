...
/*   Updated: 2025/01/06 13:05:07 by hle-hena         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_point	get_wld_coo(t_point point, t_obj obj, t_wld wld)
{
	t_point	centered;
	t_point	wld_coo;
	float	scale_factor = obj.scale * wld.cam.scale * 2;
...
t_vec	vec(t_obj obj, t_wld wld, t_point point)
{
	...
	final.x = cam_x * wld.base.i.x + cam_y * wld.base.j.x + cam_z * wld.base.k.x;
	final.y = cam_x * wld.base.i.y + cam_y * wld.base.j.y + cam_z * wld.base.k.y;
	final.z = cam_x * wld.base.i.z + cam_y * wld.base.j.z + cam_z * wld.base.k.z;

	// round_vec(&final); // Uncomment if necessary, rounding can be costly though.
	return final;
}
