...
int	main(void)
{
	...
	headings(1);
	void	*adress = (void *)0x0;
	v_printf = printf("Adress = %p", adress);
	bn();
	headings(2);
	v_ftprintf = ft_printf("Adress = %p", adress);
	bn();
	...
	headings(1);
	v_printf = printf("%u", 2148000000U);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%u", 2148000000U);
	bn();
